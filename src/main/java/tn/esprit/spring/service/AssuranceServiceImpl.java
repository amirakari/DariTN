...
public class AssuranceServiceImpl implements AssuranceService {
	...
	public Long addOrUpdateAssurance(Assurance assurance) {
		assurance.setEtat("unpaid");
		assurance.setPrix((float)0);
		if(assurance.getDateFin().after(assurance.getDateDebut())&& assurance.getEntreprise()!=null 
				 && assurance.getCode()!=null){
		assuranceRepository.save(assurance);}else{System.out.println("aaaaaa");}
