...
public class FicheServiceImpl implements FicheService {
	...
	public Long addFiche(Fiche s){
		if(s.getQuetion2()!=null && s.getQuestion3()!=null && s.getQuestion4()!=null && s.getQuestion5()!=null && s.getQuestion6()!=null
				&& s.getQuestion7()!=null && s.getQuestion8()!=null && s.getProposition()!=null){
		ficheRepository.save(s);}else{System.out.println("aaaaa");}
		return s.getId();
