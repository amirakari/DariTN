	  ...
	  ReclamationRepository reclamationRepository;
	    ...
	    public void sendMail() {
	    	...
	    	for(Reclamation r :list){
	    		if(r.getObjet().toString()=="Subscriptionproblem"){
	    		...
	    		if(r.getObjet().toString()=="PurchaseProblem"){
	    			mailMessage.setTo(r.getUser().getEmail());
	    		...
	    		if(r.getObjet().toString()=="Salesproblem"){
	    			mailMessage.setTo(r.getUser().getEmail());
	    		...
	    		if(r.getObjet().toString()=="Publishingproblem"){
	    			mailMessage.setTo(r.getUser().getEmail());
	    		...
	    		if(r.getObjet().toString()=="Problemvisit"){
	    			mailMessage.setTo(r.getUser().getEmail());
	    		...
	    		if(r.getObjet().toString()=="Furnitureproblem"){
	    			mailMessage.setTo(r.getUser().getEmail());
