...
public class SurveillanceController {
	...
	public void displayUser(Surveillance rec)
	{
	this.setNombrecamera(rec.getCamera());
	...
	public String modifyUser() {
		...
		surveillanceservice.addOrUpdateSurveillance(new Surveillance(reclamationIdToBeUpdated,datedeb,datefin,code,prix,etat,nombrecamera,user));
		}return navigateTo;
		}
	...
	public String doLogin() {
		...
		if(authenticatedSurveillance!= null && authenticatedSurveillance.getPrix() == null) {
		...
		public String removeSurv(String surveillanceId)
		{
			String navigateTo = "null"; 
			User currentuser=usercontroller.getAuthenticatedUser();
			if (currentuser==null ) {return usercontroller.gotopagelog();}else{
		...
		if(stripeService.PaySurveillance(idc,carta,expMonth,expYear,cvc)==true){
			FacesMessage facesMessage =
